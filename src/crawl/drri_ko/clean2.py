...
def gen_clean2_file() -> None:
    ...
    # meta.book_id, meta.book_title, meta.data_id, meta.elem_body_html, meta.elem_body_text, meta.elem_col, meta.elem_id, meta.elem_title_html, meta.elem_title_text, meta.elem_url, meta.mokcha_row, meta.mokcha_title, meta.page_path, meta.page_title, meta.url, meta.url2
    ...
    if 0:
        df.groupby(
            ["meta.elem_col", "meta.book_extra_type", "meta.elem_id_type"]
        ).size()
...
def main() -> None:
    ...
    #
    gen_clean2_file()  # 112.0M, e217a618
...
if __name__ == "__main__":
    if hasattr(sys, "ps1"):
        ...
        with logger.catch(onerror=lambda _: sys.exit(1)):
            # python -m src.crawl.drri_ko.clean2
            typer.run(main)
