...
def gen_book_jsonl() -> None:
    # get
    url = "https://db.itkc.or.kr/dir/item?itemId=IT#dir/list?itemId=IT&gubun=book&pageIndex=1&pageUnit=50"
...
def main() -> None:
    ...
    gen_book_jsonl()  # 275B, 2aee8ebd
    gen_book2_jsonl()  # 165B, 1417d04b, 3
...
if __name__ == "__main__":
    if hasattr(sys, "ps1"):
        ...
        with logger.catch(onerror=lambda _: sys.exit(1)):
            # python -m src.crawl.drri_ko.book
            typer.run(main)
