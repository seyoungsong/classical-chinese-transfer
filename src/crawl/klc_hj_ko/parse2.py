...
def gen_parse2_file() -> None:
    ...
    if 0:
        ...
        idx = (
            df["meta.elem_body_html"].str.contains("5fb636")
            & df["meta.elem_body_html"].str.contains("xsl_wonju")
...
def main() -> None:
    ...
    # parse html to text
    gen_parse2_file()  # 329.9M, 33ead941
...
if __name__ == "__main__":
    if hasattr(sys, "ps1"):
        ...
        with logger.catch(onerror=lambda _: sys.exit(1)):
            # python -m src.crawl.klc_hj_ko.parse2
            typer.run(main)
