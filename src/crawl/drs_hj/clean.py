...
def gen_clean_file() -> None:
    ...
    # check error
    if 0:
        # e.g.: https://sjw.history.go.kr/id/kra_11012008_001
    ...
    rcols = {
        ...
        "page_btn_html.국역": "meta.elem_btn_ko_html",
        "page_btn_html.규장각 원본": "meta.elem_btn_orig_html",
...
if __name__ == "__main__":
    if hasattr(sys, "ps1"):
        ...
        with logger.catch(onerror=lambda _: sys.exit(1)):
            # python -m src.crawl.drs_hj.clean
            typer.run(main)
