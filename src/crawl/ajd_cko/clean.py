...
def gen_clean_file() -> None:
    ...
    # drop
    dcols = ["x1.temp_id", "x1.fname", "x1.fname2", "x1.size"]
    dcols += ["dci_html", "dci_text", "copyright_html", "copyright_text"]
...
if __name__ == "__main__":
    if hasattr(sys, "ps1"):
        ...
        with logger.catch(onerror=lambda _: sys.exit(1)):
            # python -m src.crawl.ajd_cko.clean
            typer.run(main)
