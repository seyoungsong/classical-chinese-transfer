...
def gen_clean2_file() -> None:
    ...
    # meta.book_id, meta.book_title, meta.book_year, meta.data_id, meta.elem_body_html, meta.elem_body_text, meta.elem_col, meta.elem_id, meta.elem_url, meta.mokcha_row, meta.mokcha_title, meta.page_date, meta.page_path, meta.page_title, meta.url
    ...
    # add: elem_type
    df["meta.elem_id_type"] = df["meta.elem_id"].apply(
    ...
    assert len(df["meta.elem_id"].value_counts().value_counts()) == 1
...
def main() -> None:
    ...
    #
    gen_clean2_file()  # 654.9M, e8935657
...
if __name__ == "__main__":
    if hasattr(sys, "ps1"):
        ...
        with logger.catch(onerror=lambda _: sys.exit(1)):
            # python -m src.crawl.ajd_hj_oko.clean2
            typer.run(main)
