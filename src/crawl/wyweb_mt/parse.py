...
def gen_parse_dir() -> None:
    ...
    # get files
    fnames = list(sroot.CRAWL_DL_DIR.rglob("wywmt/*.tsv"))
    len(fnames)  # 7304
    if 0:
...
def main() -> None:
    ...
    gen_parse_concat_jsonl()  # 113.8M, 128c0f5f
    gen_parse_file()  # 29.8M, 699ad37b, 266514
...
if __name__ == "__main__":
    ...
    if hasattr(sys, "ps1"):
        ...
        with logger.catch(onerror=lambda _: sys.exit(1)):
            # python -m src.crawl.wyweb_mt.parse
            typer.run(main)
