...
import src.train.ner1.ajd_cc.root as sroot
...
def main() -> None:
    gen_hface_file()
    gen_hface_jsonl_dir()
    test_hface_jsonl_dir()  # {'train': 308573, 'validation': 39830, 'test': 40323}
    utils.log_written(sroot.HFACE_PQ)  # 212.2M, 59e9f5c7
...
if __name__ == "__main__":
    ...
    if hasattr(sys, "ps1"):
        ...
        with logger.catch(onerror=lambda _: sys.exit(1)):
            # python -m src.train.ner1.ajd_cc.hface_prepare
            typer.run(main)
