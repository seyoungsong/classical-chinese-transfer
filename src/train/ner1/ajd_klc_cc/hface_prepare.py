...
def main() -> None:
    gen_hface_file()
    gen_hface_jsonl_dir()
    test_hface_jsonl_dir()  # {'train': 316608, 'validation': 40825, 'test': 41358}
    utils.log_written(sroot.HFACE_PQ)  # 230.1M, 25e090fb
...
if __name__ == "__main__":
    ...
    if hasattr(sys, "ps1"):
        ...
        with logger.catch(onerror=lambda _: sys.exit(1)):
            # python -m src.train.ner1.ajd_klc_cc.hface_prepare
            typer.run(main)
