...
def main() -> None:
    gen_hface_file()
    gen_hface_jsonl_dir()
    test_hface_jsonl_dir()  # {'train': 301889, 'validation': 38825, 'test': 39358}
    utils.log_written(sroot.HFACE_PQ)  # 215.8M, 9946d6ad
...
if __name__ == "__main__":
    ...
    if hasattr(sys, "ps1"):
        ...
        with logger.catch(onerror=lambda _: sys.exit(1)):
            # python -m src.train.ner1.ajd_klc.hface_prepare
            typer.run(main)
