...
import src.train.punc.ajd_klc.root as sroot
...
def main() -> None:
    gen_hface_file()
    gen_hface_jsonl_dir()
    test_hface_jsonl_dir()  # {'train': 308174, 'validation': 39628, 'test': 40215}
    utils.log_written(sroot.HFACE_PQ)  # 204.0M, e9d1ff68
...
if __name__ == "__main__":
    ...
    if hasattr(sys, "ps1"):
        ...
        with logger.catch(onerror=lambda _: sys.exit(1)):
            # python -m src.train.punc.ajd_klc.hface_prepare
            typer.run(main)
