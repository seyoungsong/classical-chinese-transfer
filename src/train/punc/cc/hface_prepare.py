...
import src.train.punc.cc.root as sroot
...
def main() -> None:
    gen_hface_file()
    gen_hface_jsonl_dir()
    test_hface_jsonl_dir()  # {'train': 70677, 'validation': 32610, 'test': 30783}
    utils.log_written(sroot.HFACE_PQ)  # 51.4M, 0042a4c0
...
if __name__ == "__main__":
    ...
    if hasattr(sys, "ps1"):
        ...
        with logger.catch(onerror=lambda _: sys.exit(1)):
            # python -m src.train.punc.cc.hface_prepare
            typer.run(main)
