...
import src.train.punc.ajd_cc.root as sroot
...
def main() -> None:
    gen_hface_file()
    gen_hface_jsonl_dir()
    test_hface_jsonl_dir()  # {'train': 364423, 'validation': 70441, 'test': 69115}
    utils.log_written(sroot.HFACE_PQ)  # 236.2M, 31ec7dd0
...
if __name__ == "__main__":
    ...
    if hasattr(sys, "ps1"):
        ...
        with logger.catch(onerror=lambda _: sys.exit(1)):
            # python -m src.train.punc.ajd_cc.hface_prepare
            typer.run(main)
