...
import src.train.punc.ajd_klc_cc.root as sroot
...
def main() -> None:
    gen_hface_file()
    gen_hface_jsonl_dir()
    test_hface_jsonl_dir()  # {'train': 378851, 'validation': 72238, 'test': 70998}
    utils.log_written(sroot.HFACE_PQ)  # 257.0M, e89a3f16
...
if __name__ == "__main__":
    ...
    if hasattr(sys, "ps1"):
        ...
        with logger.catch(onerror=lambda _: sys.exit(1)):
            # python -m src.train.punc.ajd_klc_cc.hface_prepare
            typer.run(main)
