...
import src.train.punc.ajd_klc_cc_1_16to0.root as sroot
...
def main() -> None:
    gen_hface_file()
    gen_hface_jsonl_dir()
    test_hface_jsonl_dir()  # {'train': 212031, 'validation': 46744}
    utils.log_written(sroot.HFACE_PQ)  # 128.9M, e65749b7
...
if __name__ == "__main__":
    ...
    if hasattr(sys, "ps1"):
        ...
        with logger.catch(onerror=lambda _: sys.exit(1)):
            # python -m src.train.punc.ajd_klc_cc_2to1.hface_prepare
            typer.run(main)
